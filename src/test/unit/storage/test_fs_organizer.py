...
class TestFsOrganizer(unittest.TestCase):
    ...
    def test_generate_path(self):
        ...
        self.assertEqual(file_path, f'{self.ds_tmp_dir.name}/36/36bbe50ed96841d10443bcb670d6554f0a34b761be67ec9c4a8ad2c0c44ca42c_5', 'generate file path')
    ...
    def test_store_and_delete_file(self):
        ...
        self.check_file_presence_and_content(f'{self.ds_tmp_dir.name}/36/36bbe50ed96841d10443bcb670d6554f0a34b761be67ec9c4a8ad2c0c44ca42c_5', b'abcde')
        self.assertEqual(file_object.file_path, f'{self.ds_tmp_dir.name}/36/36bbe50ed96841d10443bcb670d6554f0a34b761be67ec9c4a8ad2c0c44ca42c_5', 'wrong file path set in file object')
