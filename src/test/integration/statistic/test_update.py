...
class TestStatistic:
    ...
    def set_pie_stats_to_dict(self, result, stats):
        ...
        assert stats == {'exploit_mitigations': [('PIE enabled', 500, 0.27778), ('PIE/DSO present', 300, 0.16667),
                                                 ('PIE disabled', 900, 0.5), ('PIE - invalid ELF file', 100, 0.05556)]}
    ...
    def set_relro_stats_to_dict(self, result, stats):
        ...
        assert stats == {'exploit_mitigations': [('RELRO fully enabled', 400, 0.19048),
    ...
    def test_get_all_stats(self):
        ...
        assert stats == {'exploit_mitigations': [('NX enabled', 800, 0.8),
                                                 ('NX disabled', 200, 0.2),
